...
Threads fetched via `bird thread` (author tweets + full replies), 2026-07-09. One web resource (GTM Atlas) discovered via an X bookmark and read directly. One DM-gated training-doc set (@coldemailchris, 7 Google Docs) unlocked and archived in-repo at [`sources/coldemailchris/`](sources/coldemailchris/) — the originals are link-rot-prone Docs exports. Classification: **SUBSTANTIVE** (actionable content in the source itself) / **PARTIAL** (real signal, incomplete) / **GATED** (lead magnet, content unreachable).
...
| 6 | @coldemailchris | 2026-07-07 | GATED→**unlocked** | 9-training copywriting masterclass; 7 docs obtained, archived in-repo | [tweet](https://x.com/coldemailchris/status/2074619017994653712) · [docs](sources/coldemailchris/) |
...
Provenance: DM-gated lead magnet ([announcement tweet](https://x.com/coldemailchris/status/2074619017994653712), 5M+ emails claimed), unlocked 2026-07. Seven docs archived in-repo — Google Docs exports rot, these don't: [`sources/coldemailchris/`](sources/coldemailchris/). The TOC promised 9 trainings; 2 are unaccounted (§11).

### 3.1 Offer tiers ([doc 1](sources/coldemailchris/1-winning-script.txt)) — NEW
...
### 3.2 Messaging principles ([doc 1](sources/coldemailchris/1-winning-script.txt))
...
### 3.3 Psychology — the 5-questions gate ([doc 2](sources/coldemailchris/2-psychology.txt)) — NEW
...
### 3.4 Six script frameworks ([doc 3](sources/coldemailchris/3-frameworks.txt)) — NEW
...
### 3.5 The 10-point send checklist ([doc 4](sources/coldemailchris/4-checklist.txt)) — NEW
...
### 3.6 Personalized relevance ([doc 5](sources/coldemailchris/5-personalized-relevance.txt)) — CONFIRMS + NEW
...
### 3.7 The 6-prompt GTM chain ([doc 6](sources/coldemailchris/6-gtm-prompts.txt)) — CONFIRMS + NEW
...
### 3.8 The interested-but-stalled nurture sequence ([doc 7](sources/coldemailchris/7-followup-prompt.txt)) — NEW
...
- Archived docs (in-repo): [1-winning-script](sources/coldemailchris/1-winning-script.txt) · [2-psychology](sources/coldemailchris/2-psychology.txt) · [3-frameworks](sources/coldemailchris/3-frameworks.txt) · [4-checklist](sources/coldemailchris/4-checklist.txt) · [5-personalized-relevance](sources/coldemailchris/5-personalized-relevance.txt) · [6-gtm-prompts](sources/coldemailchris/6-gtm-prompts.txt) · [7-followup-prompt](sources/coldemailchris/7-followup-prompt.txt)
