...
| [`11-x-primary-sources.md`](11-x-primary-sources.md) | X/Twitter primary sources (July 2026, `bird` authed) — operator threads, the coldemailchris training corpus (archived in [`sources/coldemailchris/`](sources/coldemailchris/)), the Attio GTM Atlas, conflicts vs. this dossier, skill-impact map. Partially closes Appendix C. |
